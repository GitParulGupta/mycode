package com.example.practice.code.arrays.easy.important;
...
public class LongestSubarraySumPositives {
    ...
    public int betterSolution(int[] a, int k){
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Better Solution Input :"+Arrays.toString(a1)+" k:"+k1+" "+obj.solution(a1,k1));
        System.out.println("Input:"+Arrays.toString(a1)+" k:"+k1+" "+obj.solution(a1,k1));

        System.out.println("Better Solution Input :"+Arrays.toString(a3)+" k:"+k3+" "+obj.solution(a3,k3));
